...
public class Traffic extends BasicClass {
   ...
   public Traffic() {
      ...
      while(var2.hasNext()) {
         ...
         this.features.put(feature, new BasicConfig(feature, BeanFactoryConfig.configPlace.getSelfSentenceConfigPlace().getTraffic()));
      }
