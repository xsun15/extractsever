...
public class Fraud extends BasicClass {
   ...
   public Fraud() {
      ...
      while(var2.hasNext()) {
         ...
         this.features.put(feature, new BasicConfig(feature, BeanFactoryConfig.configPlace.getSelfSentenceConfigPlace().getFraud()));
      }
