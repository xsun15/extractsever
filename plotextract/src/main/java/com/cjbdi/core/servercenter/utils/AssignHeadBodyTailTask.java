...
import com.cjbdi.core.servercenter.utils.BasicTask;
import com.cjbdi.core.servercenter.utils.ExtractCourtDecisionCallable;
...
public class AssignHeadBodyTailTask extends BasicTask {
	...
	public  JSONArray extract(JSONArray casePortraitJson) {
		...
		for(int var24 = 0; var24 < casePortraitJson.size(); ++var24) {
			...
			while(e.hasNext()) {
				...
				future.futureList.add(var22.submit(new ExtractHeadBodyTailCallable(defendantName, casecauseModel, casecause)));
			}
			var23.add(future);
		}
