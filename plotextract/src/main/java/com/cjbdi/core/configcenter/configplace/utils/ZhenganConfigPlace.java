...
public class ZhenganConfigPlace {
   private JSONObject casecauseFeature = new JSONObject();

   public ZhenganConfigPlace(HashMap<String, HashMap<String, Object>> configPlace) {
      String rootpath = configPlace.get("place").get("path").toString();
      String source = rootpath + configPlace.get("convertLabel").get("zhengAn").toString();
