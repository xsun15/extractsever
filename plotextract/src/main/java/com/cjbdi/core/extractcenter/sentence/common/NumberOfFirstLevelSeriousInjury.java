...
public class NumberOfFirstLevelSeriousInjury extends BasicSentenceFeatureClass {
   ...
   public NumberOfFirstLevelSeriousInjury(String code) {
      this.init(code);
   }

   public void init(String code) {
      this.code = code;
      this.feature = "firstlevelseriousinjurynumberextract";
      this.keyword = "重伤一级|一级重伤|重伤1级|1级重伤";
      this.noiseword = "死|轻微伤|轻伤|二级|2级";
