...
import com.cjbdi.core.extractcenter.sentence.extortion.ExtortionMoney;
...
public class InitExtractor extends InitBasicExtractor {
   ...
   private String casecause = "敲诈勒索罪";


   public InitExtractor() {
      this.init(this.casecause);
      this.basicPrivateExtractors.add(new ExtortionMoney());
      this.basicPrivateExtractors.add(new DeathNumber("1027"));
      this.basicPrivateExtractors.add(new SeriousInjuryNumber("1026"));
      this.basicPrivateExtractors.add(new MinorInjuryNumber("1028"));
      this.basicPrivateExtractors.add(new SlightInjuryNumber("1029"));
      this.basicPrivateExtractors.add(new NumberOfFirstLevelSeriousInjury("1040"));
      this.basicPrivateExtractors.add(new NumberOfSecondLevelSeriousInjury("1041"));
      this.basicPrivateExtractors.add(new NumberOfFirstLevelMinorInjury("1042"));
      this.basicPrivateExtractors.add(new NumberOfSecondLevelMinorInjury("1043"));
      this.basicPrivateExtractors.add(new FirstLevelDisability("1030"));
      this.basicPrivateExtractors.add(new SecondLevelDisability("1031"));
      this.basicPrivateExtractors.add(new ThirdLevelDisability("1032"));
      this.basicPrivateExtractors.add(new FourthLevelDisability("1033"));
      this.basicPrivateExtractors.add(new FifthLevelDisability("1034"));
      this.basicPrivateExtractors.add(new SixthLevelDisability("1035"));
      this.basicPrivateExtractors.add(new SevenLevelDisability("1036"));
      this.basicPrivateExtractors.add(new EigthLevel("1037"));
      this.basicPrivateExtractors.add(new NinthLevelDisability("1038"));
      this.basicPrivateExtractors.add(new TenthLevelDisability("1039"));
      this.basicPrivateExtractors.add(new BeingPunishedByCourtForSameCasecause("1044"));
      this.basicPrivateExtractors.add(new BeingPunishedByGovernForSameCasecause("1045"));
   }
}
