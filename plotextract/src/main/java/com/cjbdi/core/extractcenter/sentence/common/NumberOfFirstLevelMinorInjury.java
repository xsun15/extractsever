...
public class NumberOfFirstLevelMinorInjury extends BasicSentenceFeatureClass {
   ...
   public NumberOfFirstLevelMinorInjury(String code) {
      this.init(code);
   }

   public void init(String code) {
      this.code = code;
      this.feature = "firstlevelminorinjurynumberextract";
      this.keyword = "轻伤一级|一级轻伤|轻伤1级|1级轻伤";
      this.noiseword = "死|轻微伤|重伤|2级|二级";
