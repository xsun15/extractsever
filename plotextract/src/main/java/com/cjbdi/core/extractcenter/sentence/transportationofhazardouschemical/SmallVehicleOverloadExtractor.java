...
public class SmallVehicleOverloadExtractor extends BasicSentenceFeatureClass {

   private List positivepurerule;
   private String code = "1003";


   public SmallVehicleOverloadExtractor() {
      this.positivepurerule = ((ExtractFeatureBasicConfig)BeanFactoryConfig.extractFeatureConfig.getDrunkDriving().getFeatures().get("smallVehicleOverloadextract")).getPositivepurerule();
   }
