...
public class SeriousInjuryNumber extends BasicSentenceFeatureClass {
   ...
   public SeriousInjuryNumber(String code) {
      this.init(code);
   }

   public void init(String code) {
      this.code = code;
      this.feature = "seriousinjurynumberextract";
      this.keyword = "重伤";
      this.noiseword = "轻伤|轻微伤|死";
