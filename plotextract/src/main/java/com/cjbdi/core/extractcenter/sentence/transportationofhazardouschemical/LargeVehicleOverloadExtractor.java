...
public class LargeVehicleOverloadExtractor extends BasicSentenceFeatureClass {

   private List positivepurerule;
   private String code = "1001";


   public LargeVehicleOverloadExtractor() {
      this.positivepurerule = ((ExtractFeatureBasicConfig)BeanFactoryConfig.extractFeatureConfig.getDrunkDriving().getFeatures().get("largeVehicleOverloadextract")).getPositivepurerule();
   }
