...
public class EigthLevel extends BasicSentenceFeatureClass {
   ...
   public void init(String code) {
      ...
      this.keyword = "伤残(等级)?[八8]级|[八8]级伤残";
      this.noiseword = "死|轻微伤|[(重伤)(轻伤)]|[(重伤)(轻伤)][一二12]级|伤残(等级)?[9二三四五六七九十1-7]级|[9二三四五六七九十1-7]级伤残";
   ...
   public void reset() {
      if(this.positivePurePattern != null && this.positivePurePattern.size() > 0) {
         for(int i = 0; i < this.positivePurePattern.size(); ++i) {
            ...
            this.positivePurePattern.set(i, Pattern.compile(line.replaceAll("占位", "八8")));
         }
      }
