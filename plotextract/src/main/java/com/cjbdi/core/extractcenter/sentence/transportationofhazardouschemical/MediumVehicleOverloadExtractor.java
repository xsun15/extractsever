...
public class MediumVehicleOverloadExtractor extends BasicSentenceFeatureClass {

   private List positivepurerule;
   private String code = "1002";


   public MediumVehicleOverloadExtractor() {
      this.positivepurerule = ((ExtractFeatureBasicConfig) BeanFactoryConfig.extractFeatureConfig.getDrunkDriving().getFeatures().get("mediumVehicleOverloadextract")).getPositivepurerule();
   }
