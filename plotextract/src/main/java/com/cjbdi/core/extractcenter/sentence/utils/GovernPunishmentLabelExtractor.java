...
public class GovernPunishmentLabelExtractor {
   ...
   public GovernPunishmentLabelExtractor(String casecause, int deadline) {
      this.casecause = casecause;
      this.deadline = deadline;
      this.positvePureRule = ((CommonBasicConfig) BeanFactoryConfig.extractFeatureConfig.getCommon().getFeatures().get("governpunishmentextract")).getPositivepurePattern();
   }
