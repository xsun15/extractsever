...
public class NumberOfSecondLevelSeriousInjury extends BasicSentenceFeatureClass {
   ...
   public NumberOfSecondLevelSeriousInjury(String code) {
      this.init(code);
   }

   public void init(String code) {
      this.code = code;
      this.feature = "secondlevelseriousinjurynumberextract";
      this.keyword = "重伤二级|二级重伤|重伤2级|2级重伤";
      this.noiseword = "死|轻微伤|轻伤";
