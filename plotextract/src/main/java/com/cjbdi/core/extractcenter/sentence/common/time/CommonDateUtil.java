...
public class CommonDateUtil {
   ...
   private static final String[] SMART_DATE_FORMATS = new String[]{"yyyy-MM-dd HH:mm:ss", "yyyy.MM.dd HH:mm:ss", "yyyy-MM-dd HH:mm", "yyyy.MM.dd HH:mm", "yyyyMMddHHmmss", "yyyyMMddHHmm", "yyyy-MM-dd", "yyyy.MM.dd", "yyyyMMdd"};
   public static final String[] zodiacArray = new String[]{"猴", "鸡", "狗", "猪", "鼠", "牛", "虎", "兔", "龙", "蛇", "马", "羊"};
   public static final String[] constellationArray = new String[]{"水瓶座", "双鱼座", "牡羊座", "金牛座", "双子座", "巨蟹座", "狮子座", "处女座", "天秤座", "天蝎座", "射手座", "魔羯座"};
   ...
   public static final Date parseDateSmart(String strDate) {
      if(StringUtil.isEmpty(strDate)) {
         ...
         try {
            long var8 = Long.parseLong(strDate);
   ...
   public static boolean isLeapYear(int year) {
      return year / 4 * 4 != year?false:(year / 100 * 100 != year?true:year / 400 * 400 == year);
   }
   ...
   public static String formatDate(Date date) {
      ...
      return offset >= 31536000000L?formatDate(date, getDatePattern()):(offset >= 5184000000L?(offset + 1296000000L) / 2592000000L + "个月" + pos:(offset > 604800000L?(offset + 302400000L) / 604800000L + "周" + pos:(offset > 86400000L?(offset + 43200000L) / 86400000L + "天" + pos:(offset > 3600000L?(offset + 1800000L) / 3600000L + "小时" + pos:(offset > 60000L?(offset + 30000L) / 60000L + "分钟" + pos:offset / 1000L + "秒" + pos)))));
   }
   ...
   public static Date getDateAfterWeeks(Date start, int weeks) {
      return getDateAfterMs(start, (long)weeks * 604800000L);
   }
   ...
   public static Date getDateAfterDays(Date start, int days) {
      return getDateAfterMs(start, (long)days * 86400000L);
   }
   ...
   public static String date2Constellation(Date time) {
      ...
      return month >= 0?constellationArray[month]:constellationArray[11];
   }
