...
public class MinorInjuryNumber extends BasicSentenceFeatureClass {
   ...
   public MinorInjuryNumber(String code) {
      this.init(code);
   }

   public void init(String code) {
      this.code = code;
      this.feature = "minorinjurynumberextract";
      this.keyword = "轻伤";
      this.noiseword = "死|轻微伤|重伤";
